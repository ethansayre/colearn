...
class Construction extends React.Component {
    ...
    componentDidMount = () => {
        firebase.database().ref('streams/main').once('value').then((snapshot) => {
        ...
        firebase.database().ref('streams/main/image').once('value').then((snapshot) => {
            if (snapshot.val() != null) {
    ...
    renderDropDown = () => {
        ...
        for (var i = 0; i<Object.keys(this.state.images); i++) {
            return (
    ...
    updateDropDown = () => {
        firebase.database().ref('streams/main/images').once("value", (snapshot) => {
            if (snapshot.val() != null) {
            ...
            <div class="section">
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <Dropdown label={"Add Image:"} onClick={() => this.updateDropDown()}>
                            {this.renderDropDown}
                        </Dropdown>
                        <Stage
